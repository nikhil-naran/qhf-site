      ...
      <div className="mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-10 items-start">
        <div className="glass rounded-2xl p-8 border border-white/10">
          ...
          <ul className="mt-4 list-disc list-inside space-y-3 text-slate-200/90">
            ...
            <li>
              <strong>Professional mentorship</strong> — learning directly from industry leaders and alumni.
            </li>
            <li>
        ...
        <div className="space-y-6">
          <div className="glass rounded-2xl p-8 border border-white/10">
            ...
            <ul className="mt-4 list-disc list-inside space-y-3 text-slate-200/90">
              ...
              <li>
                <strong>Faculty & alumni advisors</strong> — Gain direct insights and mentorship from Queen’s professors and industry professionals.
              </li>
              <li>
